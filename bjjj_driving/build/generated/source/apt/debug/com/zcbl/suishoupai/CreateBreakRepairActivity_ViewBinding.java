...
public class CreateBreakRepairActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CreateBreakRepairActivity_ViewBinding(CreateBreakRepairActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CreateBreakRepairActivity_ViewBinding(CreateBreakRepairActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CreateBreakRepairActivity target = this.target;
